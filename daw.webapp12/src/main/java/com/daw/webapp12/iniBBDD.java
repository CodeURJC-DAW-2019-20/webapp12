...
public class iniBBDD {
    ...
    public void init(){
        ...
        Comment coment1= new Comment("Totalmente recomendado");
        Comment coment2= new Comment("¡Increible!");
        Comment coment3= new Comment("Me gusta");
        Comment coment4= new Comment("Podría estar interesado");
        Comment coment5= new Comment("Muy caro, no lo recomiendo");
        Comment coment6= new Comment("¿Cómo puedo ponerme en contacto?");
        Comment coment7= new Comment("Estaría interesado,gracias");
        Comment coment8= new Comment("Interesado, mi numero es 659540322");
        Users users5 = new Users("Maria","maria@gmail.com","12345678","ROLE_ADMIN");
        userRepository.save(users5);
        coment1.setAuthor(users5.getName());
        coment2.setAuthor(users3.getName());
        coment3.setAuthor(users2.getName());
        coment4.setAuthor(users3.getName());
        coment5.setAuthor(users5.getName());
        coment6.setAuthor(users3.getName());
        coment7.setAuthor(users2.getName());
        coment8.setAuthor(users3.getName());
        commentRepository.save(coment1);
        commentRepository.save(coment2);
        commentRepository.save(coment3);
        commentRepository.save(coment4);
        commentRepository.save(coment5);
        commentRepository.save(coment6);
        commentRepository.save(coment7);
        commentRepository.save(coment8);
        anun1.getImages().add("work-1.jpg");
        anun1.getComments().add(coment1);
        anun1.getComments().add(coment2);
        anun1.getComments().add(coment4);
        ...
        anun2.getComments().add(coment3);
        anun2.getComments().add(coment5);
        anun2.getComments().add(coment6);
        ...
        // anun3.getComments().add(coment2);
        // anun3.getComments().add(coment3);
        // anun3.getComments().add(coment5);
